...
Discover devices on your network, monitor connection quality, and detect unknown devices from a sleek web dashboard.
...
### Security Alerts
- Alerts when an unknown device joins the network
...
├── qos_monitor.py       # Latency and QoS tracking
